...
DROWS =37	#Number of data registers per strip
IROWS =37	#Number of execution rows and also the number of instruction registers per strip, must allways be <DROWS
