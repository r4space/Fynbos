#!/usr/bin/python2.6
#Converts a decimal interger into binary and hex 36bit word format
#Eg: $ ./int1.py 54
...
int_in = int(input)
print "int",int_in
if int_in>pow(2,int_bits-1)-1: #>34359738367
		print '\033[1;41mNumber too big, exiting\033[1;m'
		sys.exit(0);

if int_in<(-1*pow(2,int_bits-1)): #<-34359738368
...
d = ""
e = ""
print "2's complement of",input,", in 36bits:"
for i in range(0,len(x)):
		d = d+str(x[i])
print "Result in bin", d
