...
DROWS =10	#Number of data registers per strip
IROWS =10	#Number of execution rows and also the number of instruction registers per strip, must allways be <DROWS
STRIPS = 3	#Number of strips per tile
TILES = 2	#Number of tiles
div_strips = 2	#Number of strips with division capabilities
...
D_len = 64		#Number of bits in a data word
D_we = 	11 #Number of bits in the exponent 
D_wf = 	52 #Number of bits in the fraction , D_we+D_wf=D_len-1(sign bit)
